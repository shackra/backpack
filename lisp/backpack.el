...
(defun backpack-load-gear-files ()
  ...
  (load (expand-file-name "gears/ui/diff-hl" backpack-core-dir))
  ...
  (load (expand-file-name "gears/completion/cape" backpack-core-dir))
  (load (expand-file-name "gears/completion/eglot" backpack-core-dir))
  (load (expand-file-name "gears/completion/embark" backpack-core-dir))
  ...
  (load (expand-file-name "gears/completion/wgrep" backpack-core-dir))
  ...
  (load (expand-file-name "gears/tools/puni" backpack-core-dir))
  ...
  (load (expand-file-name "gears/editing/clojure" backpack-core-dir))
  (load (expand-file-name "gears/editing/cpp" backpack-core-dir))
  (load (expand-file-name "gears/editing/css" backpack-core-dir))
  (load (expand-file-name "gears/editing/dart" backpack-core-dir))
  ...
  (load (expand-file-name "gears/editing/html" backpack-core-dir))
  ...
  (load (expand-file-name "gears/editing/powershell" backpack-core-dir))
  ...
  (load (expand-file-name "gears/editing/sass" backpack-core-dir))
  (load (expand-file-name "gears/editing/scss" backpack-core-dir))
  (load (expand-file-name "gears/editing/svelte" backpack-core-dir))
  ...
  ;; them in `gear!'
  (when (file-exists-p (expand-file-name "packages.el" backpack-user-dir))
    (load (expand-file-name "packages.el" backpack-user-dir))))
